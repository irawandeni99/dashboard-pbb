...
<div class="panel panel-headline panel-primary">
	...
	<div class="panel-footer" style="min-height:450px;">
		<div class="row">
			<div class="col-md-12">
				<table id="example1" class="table table-condensed table-striped table-hover" style="width:100%">
				<thead hidden>
					<tr class="rowBlue">
					  <th width="100%"  class="text-bold text-center">NO</th>
					</tr>
				</thead>
				</table>
			</div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                     <div class="product-status-wrap" style="min-height:450px;">
                                        <h4 style="text-align:center;color:#006df0;" id="judul-form">PROGRAM APBD ( MURNI )</h4>
                                        <hr style="border-top:3px solid #006df0;">
                                        <div class="btn-group ib-btn-gp active-hook mail-btn-sd mg-b-15">
                                            <a class="btn btn-default btn-sm" href="<?=base_url('data-anggaran') ?>"><i class="fa fa-home"></i></a>
                                            <a class="btn btn-primary btn-sm" href="#"><?= $kode.' - '.$dinas;?></a>
                                        </div>

                                        <div class="asset-inner">
                                            <table id="table-notif" class="table table-bordered table-striped table-condensed" style="width:100%;">
                                                <thead>
                                                    <tr>
...
<script>
	...
	$('#header').select2({
		  placeholder: 'Pilih UKE 1'
		});
/* 	$(window).on('load', function () {
  		var kode = 1;
	  	$.ajax({
			  url: '<?php echo base_url('data-objek-pengawasan/get-uke1'); ?>',
			  data:{kode:kode},
			  type: 'POST',
    ...
    $(document).ready(function() {
      ...
      /*   table = $('#example1').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('notifikasi/get')?>",
                "type": "POST"
            },
