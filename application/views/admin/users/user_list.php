			  ...
			  <?php if(isset($msg) || validation_errors() !== ''): ?>
				...
				<!-- <?php echo form_open('#', 'class="form-horizontal" id="form-input"');  ?>  -->
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
							  <select name="role" id="role" class="form-control input-sm" style="width:100%">
						 ...
						 <div class="form-group user-pemdaaa" hidden>
							...
							<div class="col-sm-8">
								...
								<input data-radiocharm-label="Kabupaten/Kota" 
					 			 ...
					 			 <input type="text" name="daerah" class="form-control input-sm" id="daerah" placeholder="" >
						  </div>


						<div class="form-group user-pemda" hidden>
							<label for="prov" class="col-sm-2 control-label input-sm">Nama Daerah *</label>
						 ...
						 <div class="form-group user-kemendagri" hidden>
							<label for="prov" class="col-sm-2 control-label input-sm">Satuan Kerja *</label>
							<div class="col-sm-4">
						 ...
						 <div class="form-group user-apip" hidden>
							<label for="prov" class="col-sm-2 control-label input-sm">Apip *</label>
							<div class="col-sm-4">
							  <select name="inspektorat" id="inspektorat" class="form-control input-sm"  style="width:100%">
						 ...
						 <div class="form-group user-apip" hidden>
							<label for="prov" class="col-sm-2 control-label input-sm">Pemda *</label>
							<div class="col-sm-4">
							  <select name="pemda[]" id="pemda" class="form-control input-sm"  style="width:100%" multiple="multiple">
						 ...
						 <div class="form-group user-apip" hidden>
							<label for="prov" class="col-sm-2 control-label input-sm">Objek Pengawasan *</label>
							<div class="col-sm-4">
							  <select name="kemendagri[]" id="kemendagri" class="form-control input-sm"  style="width:100%" multiple="multiple">
...
<script>
	$(window).on('load', function () {
	  	...
	  	$.ajax({
			  url: '<?php echo base_url('data-user/getinspektorat'); ?>',
			  type: 'POST',
			  success: function(data){
    ...
    $(document).ready(function() {
        ...
        function clear_form() {
        	...
        	$('#inspektorat').removeAttr('disabled');
        	...
        	$('#inspektorat').val('');
        	$('#inspektorat').select2({placeholder: 'Pilih Inspektorat'}).trigger('change');
         ...
         $(document).on("click", "#simpan", function(e) {
		    ...
		    if (role == 1) {
		    	...
		    	var instansi = $('#inspektorat').val();

		    	 if (instansi == '') {
			 		Swal.fire({position: 'top-end',icon: 'warning',title: 'HARAP ISI DATA INSPEKTORAT',showConfirmButton: false,timer: 2000});
					exit();   	
			    }
		    }
  ...
  //        	$('#username').val('');
		...
		// });
         ...
         $("#inspektorat").change(function(){
			var ins=$(this).val();
			$.ajax({
				url: '<?php echo base_url('data-user/get-dop'); ?>',
				data:{ins:ins},
				type: 'POST'
			 //  	success: function(data){
				// }
				...
				$('#pemda').html(out.pemda);
				$('#kemendagri').html(out.kemendagri);
			})
