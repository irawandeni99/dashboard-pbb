			...
			<div class="box-body my-form-body">
			  <?php if(isset($msg) || validation_errors() !== ''): ?>
				...
				<!-- <?php echo form_open('#', 'class="form-horizontal" id="form-input"');  ?>  -->
						...
						<div class="form-group user-pemdaaaa" hidden>
						 ...
						 <div class="form-group user-apip" hidden>
							<label for="prov" class="col-sm-2 control-label input-sm">APIP <i class="req">*</i></label>
							<div class="col-sm-4">
						 ...
						 <div class="form-group user-apip user-inspektur" hidden>
							<label for="prov" class="col-sm-2 control-label input-sm">Objek Pengawasan <i class="req">*</i></label>
							<div class="col-sm-4">
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $('#example1').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('data-user/get-user-kemendagri')?>",
                "data": "{kode:kode}",
                "type": "POST"
            },
        ...
        function clear_form() {
         ...
         $(document).on("click", ".edit", function() {
    		...
    		$('#role').select2().trigger('change');
         	...
         	$("#telp").val(telp); 
         	$("#email").val(email); 
         	$("#inspektorat").val(apip); 
         	$('#inspektorat').select2().trigger('change');
				...
				$.ajax({
				  ...
				  type: 'POST',
				  	success: function(data){
         				...
         				var result = pemda.split(', ');
			         	$("#pemda").val(result); 
			         	$('#pemda').select2().trigger('change');
					}
				})
         	}else{
