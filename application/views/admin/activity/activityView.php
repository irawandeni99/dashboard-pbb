...
<div class="panel panel-headline panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title"> <i class="fa fa-laptop"></i> AKTIFITAS USER</h3>
	</div>
			...
			<div class="col-md-12">
				...
				<thead hidden>
					<tr class="rowBlue">
					  ...
					  <th width="20%" class="text-bold text-center">TANGGAL</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $('#example1').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('activity/get')?>",
                "type": "POST"
            },
...
// 	 if (tanya == true) {
//  		location.replace("<?= base_url('data-objek-pengawasan/del/'); ?>"+ckode)
// 	 }
// 	 else {
