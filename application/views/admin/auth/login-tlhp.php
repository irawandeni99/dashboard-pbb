...
<body>
	<div class="row">
		<div class="col-md-9">
			...
			<div class="panel-heading">
				<center><h4>DASHBOARD MANAJEMEN TLHP PEMDA</h4></center>
			</div>
			<div class="panel-body">
				<div class="row">
					<div class="col-md-12">
				   		<input    checked data-radiocharm-background-color="ed3326" 
						...
						<span id = "judulPencarian" class="badge badge-primary pull-right">...</span>
			   		</div>
				</div>
				
				<br>
				<div class="row">
		     		<div class="col-md-3" id="combo-prov" hidden>
		...
		<div class="col-md-3">
		    ...
		    <?php echo form_open(base_url(str_replace('=', '', base64_encode('login-tlhp'))), ''); ?>
				<div class="avatar"><img src="assets/img/kemendagri.png" style="width:64px; height:80px;"></div>
		    	<h4 class="modal-title">Login-TLHP<br><small>Sistem Informasi Pengawasan</small></h4>
	...
	<script type="text/javascript">
    	$(window).on('load', function () {
			...
			$.ajax({
				url: '<?php echo base_url('hasil-pengawasan/get-chart'); ?>',
				type: 'POST',
     ...
     //    			$("#container-nilai-temuan").html('<div style="margin-top:10px;"><center><img src="<?php echo base_url('assets/img/spinner.gif'); ?>" alt="Loading" height="150" width="150" style= "opacity:0.2;"><br>Loading ...</center></div>');
					...
					var out = jQuery.parseJSON(data);
				  	...
				  	$("#judulPencarian").html(out.judulPencarian);
