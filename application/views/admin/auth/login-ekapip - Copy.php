...
<body>
    ...
    <?php echo form_open(base_url(str_replace('=', '', base64_encode('login-ekapip'))), ''); ?>
		<div class="avatar"><img src="<?= base_url() ?>assets/img/logo-login.png" style="width:64px; height:73px;"></div>
    	<div style="color: #0078AA; text-align: center;font-size: 13px"><label  class="modal-title">Login<br>
			 Lanjutkan ke DASHBOAR-PBB</label><br><br></div>
	    ...
	    <br>
			<div center class="text-center";style="color: #0078AA;"><a href="https://siwasiat.kemendagri.go.id/"><b>Kembali Ke Dashboard</b></a></div>
    ...
    <?php echo form_close( ); ?>
	   ...
	   <div center class="text-center";style="margin-bottom:400px;"><b style="color: #F5E8E4; font-size:11px">© 2022 Insepktorat Jenderal Kementerian Dalam Negeri. All Rights Reserved</b></div>
