...
<head>
<title><?=SHORT_APP_NAME; ?> - LOGIN TLHP ITJEN</title>
...
<body oncontextmenu= "return false;">
    ...
    <?php echo form_open(base_url(str_replace('=', '', base64_encode('login-tlhp-itjen'))), ''); ?>
		<div class="avatar"><img src="<?= base_url() ?>assets/img/kemendagri.png" style="width:64px; height:80px;"></div>
    	<h4 class=""><label>LOGIN <?=SHORT_APP_NAME; ?></label><br><label style="font-size:9pt;">(PEMANTAUAN TLHP ITJEN)</label></h4>
    	<div class="form-group text-center" >
			<input checked data-radiocharm-background-color="074979" 
			data-radiocharm-text-color="FFF" data-radiocharm-label="PEMDA&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
			type="radio" class="tipe" value="pemda" name ="tipe">
			<input data-radiocharm-label="KEMENDAGRI" 
			       data-radiocharm-background-color="074979" 
			       data-radiocharm-text-color="FFF" 
			       type="radio" class="tipe" value="kemendagri" name ="tipe">
		</div>
