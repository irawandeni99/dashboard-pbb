...
<title>SIP | LOGIN</title>
	...
	<link rel="stylesheet" href="<?= base_url() ?>assets/file_upload/main.css">
...
<body>
    ...
    <?php echo form_open(base_url(str_replace('=', '', base64_encode('login-ihp'))), ''); ?>
		<div class="avatar"><img src="<?= base_url() ?>assets/img/kemendagri.png" style="width:64px; height:80px;"></div>
    	<h4 class="modal-title">Login-IHP<br><small>Sistem Informasi Pengawasan</small></h4>
