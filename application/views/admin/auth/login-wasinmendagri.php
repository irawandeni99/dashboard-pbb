...
<body>
    ...
    <?php echo form_open(base_url(str_replace('=', '', base64_encode('wasinmendagri'))), ''); ?>
		<div class="avatar"><img src="<?= base_url() ?>assets/img/kemendagri.png" style="width:64px; height:80px;"></div>
    	<h4 class="modal-title">Login-Wasinmendagri<br><small>Sistem Informasi Pengawasan</small></h4>
