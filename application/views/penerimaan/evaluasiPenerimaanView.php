    ...
    $(document).ready(function() {
        ...
        $(document).on("click", "#search", function() {
			...
			if (startDate == '') {
				...
				$.ajax({
					url: '<?php echo base_url('evaluasi-penerimaan-prev'); ?>',
					type: 'POST',
					data: {
						tahun: tahun,
						kecamatan: kecamatan,
        ...
        $(document).on("click", ".tombol-print", function() {
        	...
        	if (startDate == '') {
        		...
        		Swal.fire({
			  	...
			  	if (id == 'print-pdf') {
			  		window.open('<?php echo base_url('evaluasi-penerimaan-pdf'); ?>/'+tahun+'/'+kecamatan+'/'+startDate+'/'+endDate+'/pdf', '_blank');	
			  	}else{
					window.open('<?php echo base_url('evaluasi-penerimaan-excel'); ?>/'+tahun+'/'+kecamatan+'/'+startDate+'/'+endDate+'/excel', '_blank');
			  	}
        	}
