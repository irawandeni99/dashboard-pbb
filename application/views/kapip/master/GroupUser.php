	...
	<div class="panel-body">
      ...
      <div class="col-md-12">
				<div class="pull-right <?=$hidden; ?>">
					<a href="<?=base_url(EncryptLink('kapip-master-group/add')); ?>" type="button" name="tambah" id="tambah" class="btn btn-primary btn-lg"><i class="fa fa-plus"></i> Tambah</a>
				</div>
      </div>
    </div>
    <div class="row">
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $('#example1').DataTable({ 	
            ...
            "ajax": {
                "url": "<?php echo site_url('kapip-master-group/getTable')?>",
                "type": "POST"
            },
...
<script type="text/javascript">
	...
	$(document).on("click", ".showDetailbuttongroup", function() {
        ...
        $.ajax({
	      method: 'POST',
	      url: '<?php echo base_url(EncryptLink('kapip-master-group/add')); ?>?kode='+kode,
	    })
	    .done(function(data) {
