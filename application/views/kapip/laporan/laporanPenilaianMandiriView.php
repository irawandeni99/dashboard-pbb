...
<div class="panel panel-headline panel-primary" style="min-height:500px;">
	<div class="panel-heading">
		<h3 class="panel-title"><i class="fa fa-file-o"></i> Kertas Kerja Penilaian Mandiri Kapabilitas APIP  </h3>
	</div>
				  	...
				  	<div class="row">
						...
						<div class="col-md-8">	
							<div class="form-group">
								<div class="col-sm-2">
									<label class="col-sm-2 control-label input-sm" id="label-tipe">Instansi</label>
								</div>
								<div class="col-sm-10">
						...
						<div class="col-md-8">	
							<div class="form-group">
								<div class="col-sm-2">
									<label class="col-sm-2 control-label input-sm" id="label-tipe">Elemen</label>
								</div>
								<div class="col-sm-10">
									<select name="elemen" id="elemen" class="form-control input-sm" style="width:100%">
										<option value="">Pilih Elemen</option>
										<?php foreach($elemen as $row): ?>
											<option value="<?= $row->kd_elemen; ?>"><?=$row->kd_elemen; ?> | <?=$row->nm_elemen; ?></option>
										<?php endforeach; ?>
        ...
        $(document).on("click", "#search", function() {
			...
			if (cinstansi == '') {
				...
				Swal.fire({
						  icon: 'warning',
						  title: 'PERHATIAN',
						  text: 'PILIH ELEMEN TERLEBIH DAHULU',
						});
			}else{
        		
        		$("#treeview-mdbootstrap").html('<center><img src="<?php echo base_url('assets/img/loading.gif'); ?>" alt="Loading" height="42" width="42"></center>');
			  	$.ajax({
					  url: '<?php echo base_url('kapip-laptah-penilaian-mandiri-prev'); ?>',
					  type: 'POST',
					   data:{cinstansi:cinstansi,ctahun:ctahun,celemen:celemen},
        ...
        $(document).on("click", ".tombol-print", function() {
        	...
        	if (cinstansi == '') {
        		Swal.fire({
						  icon: 'warning',
						  title: 'PERINGATAN!',
						  text: 'INSTANSI TIDAK BOLEH KOSONG',
						});
        	}else if(celemen==''){
				Swal.fire({
						  icon: 'warning',
			  	...
			  	if (id == 'print-pdf') {
			  		window.open('<?php echo base_url('kapip-laptah-penilaian-mandiri-pdf'); ?>/'+ctahun+'/'+cinstansi+'/'+celemen+'/pdf', '_blank');	
			  	}else{
					window.open('<?php echo base_url('kapip-laptah-penilaian-mandiri-excel'); ?>/'+ctahun+'/'+cinstansi+'/'+celemen+'/excel', '_blank');
			  	}
        	}
