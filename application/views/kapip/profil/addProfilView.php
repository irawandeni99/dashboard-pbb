...
<div class="swiffy-slider">
										...
										<div class="row">
											...
											<div class="form-group"> 
												<div class="col-md-12">
													...
													<div class="col-md-1"> 
															<h3 class="panel-title"><i class="fa fa-chevron-right" aria-hidden="true" style="margin-left: 79px"></i></h3>
													</div>
																		...
																		<table id="angreal-table" class="table table-bordered table-striped" style="width:100%;" border="0">
																			<thead>
																				<tr>
																					...
																					<th style="text-align:center;background-color: #EDDFB3;color:black">
																					...
																					<th style="text-align:center; background-color: #EDDFB3;color:black"><b>URAIAN</b></th>
																					<th style="text-align:center; background-color: #EDDFB3;color:black"><b>INFORMASI</b></th>
																					<th style="text-align:center;background-color: #EDDFB3;color:black" hidden><</th>																		
																					<th style="text-align:center;background-color: #EDDFB3;"></th>
																				</tr>
																			</thead>
	...
	<?php if($profil['p2'] >=1 || $profil['p3'] >=1){  ?>
			<li>
			<div class="panel panel-headline  panel-primary">
									...
									<div class="row">
											...
											<div class="form-group"> 
												<div class="col-md-12">
													...
													<div class="col-md-11"> 
															<h3 class="panel-title"><i class="fa fa-chevron-left fa-10x" style="margin-left: -10px" aria-hidden="true"></i>  <i class="fa fa-list-alt" style="padding-left: 15px"></i> Profil Kegiatan Operasional Pengawasan APIP Dan Realisasi</h3>
									
													</div>
										
													<div class="col-md-1"> 
															<h3 class="panel-title"><i class="fa fa-chevron-right" aria-hidden="true" style="margin-left: 60px"></i></h3>
													</div>
																		...
																		<table id="Pengawasan-table" class="table table-bordered table-striped" style="width:100%" border="0">
																			<thead>
																				<tr>
																					...
																					<th style="text-align:center;background-color: #EDDFB3;color:black"><b>URAIAN</b></th>
																					<th style="text-align:center;background-color: #EDDFB3;color:black"><b>INFORMASI</b></th>
																					<th style="text-align:center;background-color: #EDDFB3;color:black" hidden><b>NILAIX</b></th>																		
																					<th style="text-align:center;background-color: #EDDFB3;"></th>
																				</tr>
																			</thead>
						...
						<div class="row">
							...
							<div class="form-group"> 
								<div class="col-md-12">
									...
									<div class="col-md-11"> 
											<h3 class="panel-title"><i class="fa fa-chevron-left fa-10x" style="padding-left: 5px" aria-hidden="true"></i>  <i class="fa fa-list-alt" style="padding-left: 10px"></i> Profil Tren Perbaikan Governance</h3>
					
									</div>
						
									<div class="col-md-1"> 
											<h3 class="panel-title"><i class="fa fa-chevron-right" aria-hidden="true" style="margin-left: 50px"></i></h3>
									</div>
												 ...
												 <table id="it-table" class="table table-bordered table-striped" style="width:100%" border="0">
																...
																<thead>
																		<tr class="rowBlue">
																		  ...
																		  <th  width="5%"  class="text-bold text-center" style="background-color: #EDDFB3;color:black" ></th>
																		  <th  width="2%"  class="text-bold text-center" hidden>clevel</th>
																		   <th  width="2%"  class="text-bold text-center" hidden>tahun</th>
																		  <th  width="40%" class="text-bold text-center" style="background-color: #EDDFB3;color:black">PROFIL</th>
																		  <th  width="45%" class="text-bold text-center" style="background-color: #EDDFB3;color:black">INFORMASI</th>
																		  <th  width="10%" class="text-bold text-center" <?=$hidden; ?> style="background-color: #EDDFB3;color:black" >AKSI</th>
																		</tr>
															...
															<table id="struktur-table" class="table table-bordered table-striped" style="width:100%" border="0">
																<thead>
																	<tr>
																		...
																		<th style="text-align:center;background-color: #EDDFB3;color:black"><b>INFORMASI</b></th>
																		<th style="text-align:center;background-color: #EDDFB3;color:black" hidden><b>NILAIX</b></th>																		
																		<th style="text-align:center;background-color: #EDDFB3;color:black"></th>
																	</tr>
																</thead>
				  	...
				  	<div class="row">
						...
						<div class="form-group"> 
							<div class="col-md-12">
								...
								<div class="col-md-11"> 
										<h3 class="panel-title"><i class="fa fa-chevron-left fa-10x" style="margin-left: -10px" aria-hidden="true"></i>  <i class="fa fa-list-alt" style="padding-left: 10px"></i> Profil IT</h3>
															...
															<table id="it-table" class="table table-bordered table-striped" style="width:100%" border="0">
																...
																<thead>
																		<tr class="rowBlue">
																		  ...
																		  <th  width="2%"  class="text-bold text-center" style="background-color: #EDDFB3;color:black"></th>
																		  <th  width="60%" class="text-bold text-center" style="background-color: #EDDFB3;color:black">PROFIL</th>
																		  <th  width="25%" class="text-bold text-center" style="background-color: #EDDFB3;color:black">INFORMASI</th>
																		  <th  width="10%" class="text-bold text-center" style="background-color: #EDDFB3;color:black">AKSI</th>
																		</tr>
...
//	let button = document.querySelector("#btnp1").click();
	...
	$('#triw').change(function(data) {		
			...
			var chide1= '<?= $profil['p1'] ?>';
			var chide2= '<?= $profil['p2'] ?>';
			var chide3= '<?= $profil['p3'] ?>';
			var chide4= '<?= $profil['p4'] ?>';
			var chide5= '<?= $profil['p5'] ?>';
			var chide6= '<?= $profil['p6'] ?>';
			var chide7= '<?= $profil['p7'] ?>';
