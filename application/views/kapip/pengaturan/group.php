 ...
 */
    ...
    $(document).ready(function() {
        ...
        table = $('#example1').DataTable({ 	
            ...
            "ajax": {
                "url": "<?php echo site_url('kapip-master-penilaian/getTable')?>",
                "type": "POST"
            },
...
<script type="text/javascript">
	...
	$(document).on("click", ".showDetailbuttonApip", function() {
        ...
        $.ajax({
	      method: 'POST',
	      url: '<?php echo base_url(EncryptLink('kapip-master-penilaian/addx')); ?>?kode='+kode+'&tahun='+tahun,
	    })
	    .done(function(data) {
					...
					//	<a href="<?=base_url(EncryptLink('kapip-master-penilaian/add')); ?>" type="button" name="tambah" id="tambah" class="btn btn-primary btn-lg"><i class="fa fa-plus"></i> Tambah</a>
