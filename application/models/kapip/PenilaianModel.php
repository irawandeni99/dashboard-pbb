...
<?php
	class PenilaianModel extends CI_Model{
	    ...
	    public function FilterElemen($cthn,$ckode)
	    {
			
			 $cgroup = $this->session->userdata('is_admin');
	 
			$query = 'SELECT SUM(e1)e1,SUM(e2)e2,SUM(e3)e3,SUM(e4)e4,SUM(e5)e5,SUM(e6)e6 FROM(
						SELECT 
						CASE WHEN kd_elemen=1 THEN jml END AS e1,
						CASE WHEN kd_elemen=2 THEN jml END AS e2,
						CASE WHEN kd_elemen=3 THEN jml END AS e3,
						CASE WHEN kd_elemen=4 THEN jml END AS e4,
						CASE WHEN kd_elemen=5 THEN jml END AS e5,
						CASE WHEN kd_elemen=6 THEN jml END AS e6
						FROM(
						SELECT  a.kd_elemen,a.nm_elemen,(SELECT COUNT(*) FROM ms_group_menu_elemen
						WHERE tahun="'.$cthn.'" AND kd_apip="'.$ckode.'" AND id_group="'.$cgroup.'" AND kd_elemen=a.kd_elemen)jml FROM ms_elemen a
						)z
						)zz';
    ...
    function get_all_apip($daerah)
	   ...
	   public function count_all_apip($daerah)
		...
		public function viewElemen1($ctahun,$cinstansi,$clevel)
		{
			...
			$query = "SELECT simpulan,(select ifnull(MAX(kd_level),0) FROM tsimpulan WHERE tahun='".$ctahun."' AND kd_apip='".$cinstansi."' AND simpulan='1')maxsimpul from tsimpulan WHERE tahun='".$ctahun."' AND kd_apip='".$cinstansi."' AND  kd_level='".$clevel."' and id_group='".$akses."'";
			$data = $this->db->query($query)->result();
			...
			$query="SELECT DISTINCT a.kd_topik,b.nm_topik,IFNULL(a.simpulan_pemenuhan,0)simpulan_pemenuhan
					...
					AND a.kd_elemen=b.kd_elemen AND a.kd_topik=b.kd_topik WHERE 
					a.kd_topik in(select kd_topik from ms_group_menu_elemen WHERE tahun='".$ctahun."' AND kd_apip='".$cinstansi."' AND kd_elemen='".$celemen."' AND id_group='".$akses."') and
					a.tahun='".$ctahun."' AND a.kd_apip='".$cinstansi."' AND a.kd_elemen='".$celemen."' AND a.kd_level='".$clevel."'
					ORDER BY kd_topik";	
		...
		$sql = "SELECT acc,nacc,(acc+nacc)jml,((acc/(acc+nacc))*100)persen FROM(
				...
				SELECT COUNT(*)acc,0 nacc FROM tpenilaian WHERE tahun='".$ctahun."' AND kd_apip='".$cinstansi."' AND kd_elemen='".$celemen."' and kd_topik='".$ckd_topik."' AND kd_level='".$clevel."' AND jawaban=1 and penjelasan<>''
				UNION
				SELECT 0 acc,COUNT(*)nacc FROM tpenilaian WHERE tahun='".$ctahun."' AND kd_apip='".$cinstansi."' AND kd_elemen='".$celemen."' and kd_topik='".$ckd_topik."' AND kd_level='".$clevel."' AND jawaban=0 and penjelasan<>''
				)z)zz";
		...
		if($persenjawab==100){
			...
			$iconjawab='<span  class="fa fa-window-close-o fa-3x" aria-hidden="true" style="color: #fc544b; margin-left:108%; margin-top:-5%">
				...
				$html.='<details id="det_topikE1_'.$cno.'">
						...
						$data2 = $this->db->query($query2)->result();
							...
							foreach ($data2 as $value2) {
								...
								if($cpenjelasan==''){
									...
									$html.='<div class="col-md-12" style="margin-left: 25px"> <br>
												...
												<fieldset>
														<details>
															...
															<textarea id="cpenjelasanE1_'.$xno.'" style="font-size:10pt;display:none;" class="form-control" readonly rows="4">'.$cpenjelasan.'</textarea>
									...
									$html.='<div class="col-md-12" style="margin-left: 25px"> 
											<fieldset>
													<details id="det_penilaianE1_'.$cno.'_'.$xno.'">

														<summary style="font-size: 13px;color: black; text-align: left; " data-toggle="tooltip" data-placement="top" title="Klik Jawaban dan Verifikasi Data KAPIP">
															<div class="col-md-11" style="margin-left: 25px; cursor: pointer;"> 
																	<div class="col-md-1"><lebel style="text-align: left;">'.$cpoin.'</label></div> 
									...
									$html.='<div class="col-md-12">				
												...
												<summary style="font-size: 13px;color: black; text-align: left; " data-toggle="tooltip" data-placement="top" title="Klik Penjelasan Pemenuhan Topik Penilaian KAPIP">
															<div class="col-md-11" style="margin-left: 25px; cursor: pointer;"> 
																	<div class="col-md-12"><lebel style="text-align: left;margin-left:15px;">Detail  </label><i class="fa fa-caret-square-o-down fa-lg" style="color: #18978F;" ></i></div> 
															</summary>
												
														<div class="col-md-11" style="margin-left: 45px"><br> 
																	<lebel style="text-align: left; font-size: 14px;color: #18978F;"><b>Penjelasan Uraian Aspek</b></label>
																	<textarea id="cpenjelasanE1_'.$xno.'" style="font-size:10pt;" class="form-control" readonly  rows="4">'.$cpenjelasan.'</textarea>
															<br>
														</div>
											...
											<div class="col-sm-5" style="margin-left: 65px"><br>											
												<label class="switch">
							...
							if($csimpulan==1){
									...
									$xno2=1;
									$btnE1_upl 		= '<a class="list-group-item list-group-item-action "  onclick="uploadFileE1('.$celemen.','.$xno.','.$xno2.','.$cno.')"; ><i class="fa fa-cloud-upload fa-1x" aria-hidden="true" style="color: #006E7F" ></i> Upload File</a>';
						...
						$html.='<div class="col-sm-8" style="margin-left: 80px;">
									<table id="xx" class="table table-bordered table-striped" style="width:100%;" border="0">
										...
										<thead>
											...
											$html.='<tr>
														<td style="width:30px">		
															<input type="file" style="width: 240px" name="fileuploadE1_'.$xno.'_'.$xno2.'" id="fileuploadE1_'.$xno.'_'.$xno2.'" value="" onchange="validateFormat(this,'.$celemen.','.$xno.','.$xno2.')" />
														</td>
						...
						<div class="col-sm-3"> 
								...
								foreach ($data3 as $value3) {
									...
									$edit="EditFileE1('".$ctahun."','".$cinstansi."','".$celemen."','".$ctopik."','".$clevel."','".$cpenilaian."','".$cfile."','".$cnmfile."','".$xno."','".$cno3."')";								
	...
	//cekdnii
									...
									$aa="hapusFileE1('".$ctahun."','".$cinstansi."','".$celemen."','".$ctopik."','".$clevel."','".$cpenilaian."','".$cfile."','".$cnmfile."','".$xno."')"; 
										...
										$html.='<tr>
											...
											$btnE1_upl	= '<a class="list-group-item list-group-item-action "  onclick="uploadFileE1('.$celemen.','.$xno.','.$cnext.','.$cno.')"; ><i class="fa fa-cloud-upload fa-1x" aria-hidden="true" style="color: #006E7F" ></i> Upload file</a>';									
											...
											$html.='<tr>
														<td style="width:30px">		
															<input type="file" style="width: 240px" name="fileuploadE1_'.$xno.'_'.$cnext.'" id="fileuploadE1_'.$xno.'_'.$cnext.'" value="" onchange="validateFormat(this,'.$celemen.','.$xno.','.$cnext.')" />
														</td>
	...
	$html .='<button type="button" '.$disable.' class="btn btn-success btn-lg simpan-elemen1" data-jml="'.$xno.'" data-jmltopik="'.$cno.'" ><i class="fa fa-check-square"></i> SIMPAN</button>
		...
		if($persenjawab==100){
			...
			$iconjawab='<span  class="fa fa-window-close-o fa-3x" aria-hidden="true" style="color: #fc544b; margin-left:108%; margin-top:-5%">
				...
				$html.='<details id="det_topikE2_'.$cno.'">
						<summary style="font-size: 13px;color: black; text-align: left; " data-toggle="tooltip" data-placement="top" title="Klik Penjelasan Pemenuhan Topik Penilaian KAPIP">
							<div class="col-md-12"><br> 
									<h3 class="panel-title"><i class="fa fa-ravelry" ></i>  <b> <lebel id="lbtopik" style="text-align: left;">Topik '.$cno.' : '.$cnm_topik.'</label></b> </h3>
							<br></div></summary>';
						...
						$data2 = $this->db->query($query2)->result();
							...
							foreach ($data2 as $value2) {
								...
								if($cpenjelasan==''){
									...
									$html.='<div class="col-md-12" style="margin-left: 25px"> <br>
												...
												<fieldset>
														<details>
															...
															<textarea id="cpenjelasanE2_'.$xno.'" style="font-size:10pt;display:none;" class="form-control" readonly rows="4">'.$cpenjelasan.'</textarea>
									...
									$html.='<div class="col-md-12" hidden>				
										<details>
										...
										<summary style="font-size: 13px;color: black; text-align: left; " data-toggle="tooltip" data-placement="top" title="Klik Penjelasan Pemenuhan Topik Penilaian KAPIP">
												...
												<div class="col-md-11" style="margin-left: 45px"><br> 
															<lebel style="text-align: left; font-size: 14px;color: #18978F;"><b>Penjelasan Uraian Aspek</b></label>
															<textarea style="font-size:10pt;" class="form-control" readonly  rows="4"></textarea>
													<br>
												</div>
									...
									$html.='<div class="col-md-12" style="margin-left: 25px"> 
											<fieldset>
													<details id="det_penilaianE2_'.$cno.'_'.$xno.'">
									...
									$html.='<div class="col-md-12">				
												...
												<summary style="font-size: 13px;color: black; text-align: left; " data-toggle="tooltip" data-placement="top" title="Klik Penjelasan Pemenuhan Topik Penilaian KAPIP">
														...
														<div class="col-md-11" style="margin-left: 45px"><br> 
																	<lebel style="text-align: left; font-size: 14px;color: #18978F;"><b>Penjelasan Uraian Aspek</b></label>
																	<textarea id="cpenjelasanE2_'.$xno.'"style="font-size:10pt;" class="form-control" readonly  rows="4">'.$cpenjelasan.'</textarea>
															<br>
														</div>
							...
							if($csimpulan==1){
									...
									$xno2=1;
									$btnE2_upl 		= '<a class="list-group-item list-group-item-action "  onclick="uploadFileE2('.$celemen.','.$xno.','.$xno2.','.$cno.')"; ><i class="fa fa-cloud-upload fa-1x" aria-hidden="true" style="color: #006E7F" ></i> Upload File</a>';
						...
						$html.='<div class="col-sm-8" style="margin-left: 80px;">
									<table id="xx" class="table table-bordered table-striped" style="width:100%;" border="0">
										...
										<thead>
											...
											$html.='<tr>
														<td style="width:30px">		
															<input type="file" style="width: 240px" name="fileuploadE2_'.$xno.'_'.$xno2.'" id="fileuploadE2_'.$xno.'_'.$xno2.'" value="" onchange="validateFormat(this,'.$celemen.','.$xno.','.$xno2.')" />
														</td>
						...
						<div class="col-sm-3"> 
								...
								foreach ($data3 as $value3) {
									...
									$edit="EditFileE2('".$ctahun."','".$cinstansi."','".$celemen."','".$ctopik."','".$clevel."','".$cpenilaian."','".$cfile."','".$cnmfile."','".$xno."','".$cno3."')";
									$btnE2_Edit = '<a class="list-group-item list-group-item-action" onclick='.$edit.' ><i class="fa fa-pencil-square-o" aria-hidden="true" style="color: #F15412"></i> Edit File</a>';

		
									$aa="hapusFileE2('".$ctahun."','".$cinstansi."','".$celemen."','".$ctopik."','".$clevel."','".$cpenilaian."','".$cfile."','".$cnmfile."','".$xno."')";
										...
										if($csimpulan==1){
											...
											$subbutton=$btnE2_View.$btnE2_Edit.$btnE2_Del;
										...
										$html.='<tr>
											...
											$btnE2_upl	= '<a class="list-group-item list-group-item-action "  onclick="uploadFileE2('.$celemen.','.$xno.','.$cnext.','.$cno.')"; ><i class="fa fa-cloud-upload fa-1x" aria-hidden="true" style="color: #006E7F" ></i> Upload file</a>';									
											...
											$html.='<tr>
														<td style="width:30px">		
															<input type="file" style="width: 240px" name="fileuploadE2_'.$xno.'_'.$cnext.'" id="fileuploadE2_'.$xno.'_'.$cnext.'" value="" onchange="validateFormat(this,'.$celemen.','.$xno.','.$cnext.')" />
														</td>
	...
	$html .='<button type="button" '.$disable.' class="btn btn-success btn-lg simpan-elemen2" data-jml="'.$xno.'" data-jmltopik="'.$cno.'"><i class="fa fa-check-square"></i> SIMPAN</button>
		...
		if($persenjawab==100){
			...
			$iconjawab='<span  class="fa fa-window-close-o fa-3x" aria-hidden="true" style="color: #fc544b; margin-left:108%; margin-top:-5%">
				...
				$html.='<details id="det_topikE3_'.$cno.'">
						<summary style="font-size: 13px;color: black; text-align: left; " data-toggle="tooltip" data-placement="top" title="Klik Penjelasan Pemenuhan Topik Penilaian KAPIP">
							<div class="col-md-12"><br> 
									<h3 class="panel-title"><i class="fa fa-ravelry" ></i>  <b> <lebel id="lbtopik" style="text-align: left;">Topik '.$cno.' : '.$cnm_topik.'</label></b> </h3>
							<br></div></summary>';
						...
						$data2 = $this->db->query($query2)->result();
							...
							foreach ($data2 as $value2) {
								...
								if($cpenjelasan==''){
									...
									$html.='<div class="col-md-12" style="margin-left: 25px"> <br>
												...
												<fieldset>
														<details>
															...
															<textarea id="cpenjelasanE3_'.$xno.'" style="font-size:10pt;display:none;" class="form-control" readonly rows="4">'.$cpenjelasan.'</textarea>
									...
									$html.='<div class="col-md-12" style="margin-left: 25px"> 
											<fieldset>
													<details id="det_penilaianE3_'.$cno.'_'.$xno.'">
									...
									$html.='<div class="col-md-12">				
												...
												<summary style="font-size: 13px;color: black; text-align: left; " data-toggle="tooltip" data-placement="top" title="Klik Penjelasan Pemenuhan Topik Penilaian KAPIP">
														...
														<div class="col-md-11" style="margin-left: 45px"><br> 
																	<lebel style="text-align: left; font-size: 14px;color: #18978F;"><b>Penjelasan Uraian Aspek</b></label>
																	<textarea id="cpenjelasanE3_'.$xno.'" style="font-size:10pt;" class="form-control" readonly  rows="4">'.$cpenjelasan.'</textarea>
															<br>
														</div>
							...
							if($csimpulan==1){
									...
									$xno2=1;
									$btnE3_upl 		= '<a class="list-group-item list-group-item-action "  onclick="uploadFileE3('.$celemen.','.$xno.','.$xno2.','.$cno.')"; ><i class="fa fa-cloud-upload fa-1x" aria-hidden="true" style="color: #006E7F" ></i> Upload File</a>';
						...
						$html.='<div class="col-sm-8" style="margin-left: 80px;">
									<table id="xx" class="table table-bordered table-striped" style="width:100%;" border="0">
										...
										<thead>
											...
											$html.='<tr>
														<td style="width:30px">		
															<input type="file" style="width: 240px" name="fileuploadE3_'.$xno.'_'.$xno2.'" id="fileuploadE3_'.$xno.'_'.$xno2.'" value="" onchange="validateFormat(this,'.$celemen.','.$xno.','.$xno2.')" />
														</td>
						...
						<div class="col-sm-3"> 
								...
								foreach ($data3 as $value3) {
									...
									$edit="EditFileE3('".$ctahun."','".$cinstansi."','".$celemen."','".$ctopik."','".$clevel."','".$cpenilaian."','".$cfile."','".$cnmfile."','".$xno."','".$cno3."')";						
									$btnE3_Edit = '<a class="list-group-item list-group-item-action" onclick='.$edit.' ><i class="fa fa-pencil-square-o" aria-hidden="true" style="color: #F15412"></i> Edit File</a>';
	
		
									$aa="hapusFileE3('".$ctahun."','".$cinstansi."','".$celemen."','".$ctopik."','".$clevel."','".$cpenilaian."','".$cfile."','".$cnmfile."','".$xno."')";
										...
										if($csimpulan==1){
											...
											$subbutton=$btnE3_View.$btnE3_Edit.$btnE3_Del;
										...
										$html.='<tr>
											...
											$btnE3_upl	= '<a class="list-group-item list-group-item-action "  onclick="uploadFileE3('.$celemen.','.$xno.','.$cnext.','.$cno.')"; ><i class="fa fa-cloud-upload fa-1x" aria-hidden="true" style="color: #006E7F" ></i> Upload file</a>';									
											...
											$html.='<tr>
														<td style="width:30px">		
															<input type="file" style="width: 240px" name="fileuploadE3_'.$xno.'_'.$cnext.'" id="fileuploadE3_'.$xno.'_'.$cnext.'" value="" onchange="validateFormat(this,'.$celemen.','.$xno.','.$cnext.')" />
														</td>
	...
	$html .='<button type="button" '.$disable.' class="btn btn-success btn-lg simpan-elemen3" data-jml="'.$xno.'" data-jmltopik="'.$cno.'"><i class="fa fa-check-square"></i> SIMPAN</button>
		...
		if($persenjawab==100){
			...
			$iconjawab='<span  class="fa fa-window-close-o fa-3x" aria-hidden="true" style="color: #fc544b; margin-left:108%; margin-top:-5%">
				...
				$html.='<details id="det_topikE4_'.$cno.'">
						<summary style="font-size: 13px;color: black; text-align: left; " data-toggle="tooltip" data-placement="top" title="Klik Penjelasan Pemenuhan Topik Penilaian KAPIP">
							<div class="col-md-12"><br> 
									<h3 class="panel-title"><i class="fa fa-ravelry" ></i>  <b> <lebel id="lbtopik" style="text-align: left;">Topik '.$cno.' : '.$cnm_topik.'</label></b> </h3>
							<br></div></summary>';
						...
						$data2 = $this->db->query($query2)->result();
							...
							foreach ($data2 as $value2) {
								...
								if($cpenjelasan==''){
									...
									$html.='<div class="col-md-12" style="margin-left: 25px"> <br>
												...
												<fieldset>
														<details>
															...
															<textarea id="cpenjelasanE4_'.$xno.'" style="font-size:10pt;display:none;" class="form-control" readonly rows="4">'.$cpenjelasan.'</textarea>
									...
									$html.='<div class="col-md-12" style="margin-left: 25px"> 
											<fieldset>
													<details id="det_penilaianE4_'.$cno.'_'.$xno.'">
									...
									$html.='<div class="col-md-12">				
												...
												<summary style="font-size: 13px;color: black; text-align: left; " data-toggle="tooltip" data-placement="top" title="Klik Penjelasan Pemenuhan Topik Penilaian KAPIP">
														...
														<div class="col-md-11" style="margin-left: 45px"><br> 
																	<lebel style="text-align: left; font-size: 14px;color: #18978F;"><b>Penjelasan Uraian Aspek</b></label>
																	<textarea id="cpenjelasanE4_'.$xno.'" style="font-size:10pt;" class="form-control" readonly  rows="4">'.$cpenjelasan.'</textarea>
															<br>
														</div>
							...
							if($csimpulan==1){
									...
									$xno2=1;
									$btnE4_upl 		= '<a class="list-group-item list-group-item-action "  onclick="uploadFileE4('.$celemen.','.$xno.','.$xno2.','.$cno.')"; ><i class="fa fa-cloud-upload fa-1x" aria-hidden="true" style="color: #006E7F" ></i> Upload File</a>';
						...
						$html.='<div class="col-sm-8" style="margin-left: 80px;">
									<table id="xx" class="table table-bordered table-striped" style="width:100%;" border="0">
										...
										<thead>
											...
											$html.='<tr>
														<td style="width:30px">		
															<input type="file" style="width: 240px" name="fileuploadE4_'.$xno.'_'.$xno2.'" id="fileuploadE4_'.$xno.'_'.$xno2.'" value="" onchange="validateFormat(this,'.$celemen.','.$xno.','.$xno2.')" />
														</td>
						...
						<div class="col-sm-3"> 
								...
								foreach ($data3 as $value3) {
									...
									$edit="EditFileE4('".$ctahun."','".$cinstansi."','".$celemen."','".$ctopik."','".$clevel."','".$cpenilaian."','".$cfile."','".$cnmfile."','".$xno."','".$cno3."')";						
									$btnE4_Edit = '<a class="list-group-item list-group-item-action" onclick='.$edit.' ><i class="fa fa-pencil-square-o" aria-hidden="true" style="color: #F15412"></i> Edit File</a>';
				
		
									$aa="hapusFileE4('".$ctahun."','".$cinstansi."','".$celemen."','".$ctopik."','".$clevel."','".$cpenilaian."','".$cfile."','".$cnmfile."','".$xno."')";
										...
										if($csimpulan==1){
											...
											$subbutton=$btnE4_View.$btnE4_Edit.$btnE4_Del;
										...
										$html.='<tr>
											...
											$btnE4_upl	= '<a class="list-group-item list-group-item-action "  onclick="uploadFileE4('.$celemen.','.$xno.','.$cnext.','.$cno.')"; ><i class="fa fa-cloud-upload fa-1x" aria-hidden="true" style="color: #006E7F" ></i> Upload file</a>';									
											...
											$html.='<tr>
														<td style="width:30px">		
															<input type="file" style="width: 240px" name="fileuploadE4_'.$xno.'_'.$cnext.'" id="fileuploadE4_'.$xno.'_'.$cnext.'" value="" onchange="validateFormat(this,'.$celemen.','.$xno.','.$cnext.')" />
														</td>
	...
	$html .='<button type="button" '.$disable.' class="btn btn-success btn-lg simpan-elemen4" data-jml="'.$xno.'" data-jmltopik="'.$cno.'" ><i class="fa fa-check-square"></i> SIMPAN</button>
		...
		if($persenjawab==100){
			...
			$iconjawab='<span  class="fa fa-window-close-o fa-3x" aria-hidden="true" style="color: #fc544b; margin-left:108%; margin-top:-5%">
				...
				$html.='<details id="det_topikE5_'.$cno.'">
						<summary style="font-size: 13px;color: black; text-align: left; " data-toggle="tooltip" data-placement="top" title="Klik Penjelasan Pemenuhan Topik Penilaian KAPIP">
							<div class="col-md-12"><br> 
									<h3 class="panel-title"><i class="fa fa-ravelry" ></i>  <b> <lebel id="lbtopik" style="text-align: left;">Topik '.$cno.' : '.$cnm_topik.'</label></b> </h3>
							<br></div></summary>';
						...
						$data2 = $this->db->query($query2)->result();
							...
							foreach ($data2 as $value2) {
								...
								if($cpenjelasan==''){
									...
									$html.='<div class="col-md-12" style="margin-left: 25px"> <br>
												...
												<fieldset>
														<details>
															...
															<textarea id="cpenjelasanE5_'.$xno.'" style="font-size:10pt;display:none;" class="form-control" readonly rows="4">'.$cpenjelasan.'</textarea>
									...
									$html.='<div class="col-md-12" style="margin-left: 25px"> 
											<fieldset>
													<details id="det_penilaianE5_'.$cno.'_'.$xno.'">
									...
									$html.='<div class="col-md-12">				
												...
												<summary style="font-size: 13px;color: black; text-align: left; " data-toggle="tooltip" data-placement="top" title="Klik Penjelasan Pemenuhan Topik Penilaian KAPIP">
														...
														<div class="col-md-11" style="margin-left: 45px"><br> 
																	<lebel style="text-align: left; font-size: 14px;color: #18978F;"><b>Penjelasan Uraian Aspek</b></label>
																	<textarea id="cpenjelasanE5_'.$xno.'" style="font-size:10pt;" class="form-control" readonly  rows="4">'.$cpenjelasan.'</textarea>
															<br>
														</div>
							...
							if($csimpulan==1){
									...
									$xno2=1;
									$btnE5_upl 		= '<a class="list-group-item list-group-item-action "  onclick="uploadFileE5('.$celemen.','.$xno.','.$xno2.','.$cno.')"; ><i class="fa fa-cloud-upload fa-1x" aria-hidden="true" style="color: #006E7F" ></i> Upload File</a>';
						...
						$html.='<div class="col-sm-8" style="margin-left: 80px;">
									<table id="xx" class="table table-bordered table-striped" style="width:100%;" border="0">
										...
										<thead>
											...
											$html.='<tr>
														<td style="width:30px">		
															<input type="file" style="width: 240px" name="fileuploadE5_'.$xno.'_'.$xno2.'" id="fileuploadE5_'.$xno.'_'.$xno2.'" value="" onchange="validateFormat(this,'.$celemen.','.$xno.','.$xno2.')" />
														</td>
						...
						<div class="col-sm-3"> 
								...
								foreach ($data3 as $value3) {
									...
									$edit="EditFileE5('".$ctahun."','".$cinstansi."','".$celemen."','".$ctopik."','".$clevel."','".$cpenilaian."','".$cfile."','".$cnmfile."','".$xno."','".$cno3."')";
									$btnE5_Edit = '<a class="list-group-item list-group-item-action" onclick='.$edit.' ><i class="fa fa-pencil-square-o" aria-hidden="true" style="color: #F15412"></i> Edit File</a>';
				
		
									$aa="hapusFileE5('".$ctahun."','".$cinstansi."','".$celemen."','".$ctopik."','".$clevel."','".$cpenilaian."','".$cfile."','".$cnmfile."','".$xno."')";
										...
										if($csimpulan==1){
											...
											$subbutton=$btnE5_View.$btnE5_Edit.$btnE5_Del;
										...
										$html.='<tr>
											...
											$btnE5_upl	= '<a class="list-group-item list-group-item-action "  onclick="uploadFileE5('.$celemen.','.$xno.','.$cnext.','.$cno.')"; ><i class="fa fa-cloud-upload fa-1x" aria-hidden="true" style="color: #006E7F" ></i> Upload file</a>';									
											...
											$html.='<tr>
														<td style="width:30px">		
															<input type="file" style="width: 240px" name="fileuploadE5_'.$xno.'_'.$cnext.'" id="fileuploadE5_'.$xno.'_'.$cnext.'" value="" onchange="validateFormat(this,'.$celemen.','.$xno.','.$cnext.')" />
														</td>
	...
	$html .='<button type="button" '.$disable.' class="btn btn-success btn-lg simpan-elemen5" data-jml="'.$xno.'" data-jmltopik="'.$cno.'" ><i class="fa fa-check-square"></i> SIMPAN</button>
		...
		if($persenjawab==100){
			...
			$iconjawab='<span  class="fa fa-window-close-o fa-3x" aria-hidden="true" style="color: #fc544b; margin-left:108%; margin-top:-5%">
				...
				$html.='<details id="det_topikE6_'.$cno.'">
						<summary style="font-size: 13px;color: black; text-align: left; " data-toggle="tooltip" data-placement="top" title="Klik Penjelasan Pemenuhan Topik Penilaian KAPIP">
							<div class="col-md-12"><br> 
									<h3 class="panel-title"><i class="fa fa-ravelry" ></i>  <b> <lebel id="lbtopik" style="text-align: left;">Topik '.$cno.' : '.$cnm_topik.'</label></b> </h3>
							<br></div></summary>';
						...
						$data2 = $this->db->query($query2)->result();
							...
							foreach ($data2 as $value2) {
								...
								if($cpenjelasan==''){
									...
									$html.='<div class="col-md-12" style="margin-left: 25px"> <br>
												...
												<fieldset>
														<details>
															...
															<textarea id="cpenjelasanE6_'.$xno.'" style="font-size:10pt;display:none;" class="form-control" readonly rows="4">'.$cpenjelasan.'</textarea>
									...
									$html.='<div class="col-md-12" style="margin-left: 25px"> 
											<fieldset>
													<details id="det_penilaianE6_'.$cno.'_'.$xno.'">
									...
									$html.='<div class="col-md-12">				
												...
												<summary style="font-size: 13px;color: black; text-align: left; " data-toggle="tooltip" data-placement="top" title="Klik Penjelasan Pemenuhan Topik Penilaian KAPIP">
														...
														<div class="col-md-11" style="margin-left: 45px"><br> 
																	<lebel style="text-align: left; font-size: 14px;color: #18978F;"><b>Penjelasan Uraian Aspek</b></label>
																	<textarea id="cpenjelasanE6_'.$xno.'" style="font-size:10pt;" class="form-control" readonly  rows="4">'.$cpenjelasan.'</textarea>
															<br>
														</div>
							...
							if($csimpulan==1){
									...
									$xno2=1;
									$btnE6_upl 		= '<a class="list-group-item list-group-item-action "  onclick="uploadFileE6('.$celemen.','.$xno.','.$xno2.','.$cno.')"; ><i class="fa fa-cloud-upload fa-1x" aria-hidden="true" style="color: #006E7F" ></i> Upload File</a>';
						...
						$html.='<div class="col-sm-8" style="margin-left: 80px;">
									<table id="xx" class="table table-bordered table-striped" style="width:100%;" border="0">
										...
										<thead>
											...
											$html.='<tr>
														<td style="width:30px">		
															<input type="file" style="width: 240px" name="fileuploadE6_'.$xno.'_'.$xno2.'" id="fileuploadE6_'.$xno.'_'.$xno2.'" value="" onchange="validateFormat(this,'.$celemen.','.$xno.','.$xno2.')" />
														</td>
						...
						<div class="col-sm-3"> 
								...
								foreach ($data3 as $value3) {
									...
									$edit="EditFileE6('".$ctahun."','".$cinstansi."','".$celemen."','".$ctopik."','".$clevel."','".$cpenilaian."','".$cfile."','".$cnmfile."','".$xno."','".$cno3."')";
									$btnE6_Edit = '<a class="list-group-item list-group-item-action" onclick='.$edit.' ><i class="fa fa-pencil-square-o" aria-hidden="true" style="color: #F15412"></i> Edit File</a>';
			
		
									$aa="hapusFileE6('".$ctahun."','".$cinstansi."','".$celemen."','".$ctopik."','".$clevel."','".$cpenilaian."','".$cfile."','".$cnmfile."','".$xno."')";
										...
										if($csimpulan==1){
											...
											$subbutton=$btnE6_View.$btnE6_Edit.$btnE6_Del;
										...
										$html.='<tr>
											...
											$btnE6_upl	= '<a class="list-group-item list-group-item-action "  onclick="uploadFileE6('.$celemen.','.$xno.','.$cnext.','.$cno.')"; ><i class="fa fa-cloud-upload fa-1x" aria-hidden="true" style="color: #006E7F" ></i> Upload file</a>';									
											...
											$html.='<tr>
														<td style="width:30px">		
															<input type="file" style="width: 240px" name="fileuploadE6_'.$xno.'_'.$cnext.'" id="fileuploadE6_'.$xno.'_'.$cnext.'" value="" onchange="validateFormat(this,'.$celemen.','.$xno.','.$cnext.')" />
														</td>
...
<div class="panel-footer">
	...
	$html .='<button type="button" '.$disable.' class="btn btn-success btn-lg simpan-elemen6" data-jml="'.$xno.'" data-jmltopik="'.$cno.'" ><i class="fa fa-check-square"></i> SIMPAN</button>
		...
		public function viewSimpulan1($ctahun,$cinstansi,$clevel)
		{
				
			$akses = $this->session->userdata('is_admin');

				
			$query="SELECT *from tsimpulan WHERE tahun='".$ctahun."' AND kd_apip='".$cinstansi."' AND  kd_level='".$clevel."' and id_group='".$akses."'";
			$data = $this->db->query($query)->result();
			
			$csql = "SELECT simpulan,(select ifnull(MAX(kd_level),0) FROM tsimpulan WHERE tahun='".$ctahun."' AND kd_apip='".$cinstansi."' AND simpulan='1' and and id_group='".$akses."')maxsimpul from tsimpulan WHERE tahun='".$ctahun."' AND kd_apip='".$cinstansi."' AND  kd_level='".$clevel."' and id_group='".$akses."'";
			...
			if($csimpulan==1){
				...
				$html.='<div class="row">
								<div class="col-md-12" style="background-color: #EDDFB3;color:black;margin-left: 15px; align:center"><br><br>
					
									<lebel style="text-align: left; font-size: 13px;color: black;">Untuk melihat simpulan penilaian mandiri pastikan seluruh kuisioner telah di isi dengan benar.<br>
										Klik/centang pernyataan "<label style="font-size: 14px;color: #18978F;">Ya, saya telah menyelesaikan pengisian penilaian mandiri</label>", kemudain klik tombol <label style="font-size: 14px;color: #18978F;">SIMPAN FINAL</label> <br>untuk menyatakan
										bahwa pengisian penilaian mandiri yang dilakukan telah selesai.<br>
										Jika menekan tombol <label style="font-size: 14px;color: #18978F;">SIMPAN FINAL</label>. Proses penilaian mandiri/assessmen dinyatakan selesai dan tidak dimungkinkan lagi melakukan perubahan.
									</label> <br><br><br>				
						...
						<div class="col-sm-12" style="margin-left: 35px"><br>
								<input type="checkbox" id="chsimpulan_'.$clevel.'" name="chsimpulan_'.$clevel.'" '.$chk.' value='.$csimpulan.' >	<label style="font-size: 14px;color: #18978F;">Ya, saya telah menyelesaikan pengisian penilaian mandiri</label>					
								<br><br>
						</div>';
...
/* 		$query="SELECT jns,kd_elemen,kd_topik,uraian,kd_jns_elemen,bobot,varkali,clevel1,clevel2,clevel3,clevel4,clevel5,skor_topik,ROUND(simpulan,4)simpulan,satuan, 
			...
			((bobot/100*varkali)/100) AS satuan,
			CASE 
			...
			FROM(
				...
				(IFNULL(clevel1,0)+IFNULL(clevel2,0)+IFNULL(clevel3,0)+IFNULL(clevel4,0)+IFNULL(clevel5,0))skor_topik
				 ...
				 FROM(
					SELECT tahun,kd_elemen,kd_apip,kd_topik,SUM(clevel1)clevel1,SUM(clevel2)clevel2,SUM(clevel3)clevel3,SUM(clevel4)clevel4,SUM(clevel5)clevel5,
						...
						SELECT tahun,kd_apip,kd_elemen,kd_topik,
						CASE WHEN kd_level=1 THEN simpulan_pemenuhan END AS clevel1,
						CASE WHEN kd_level=2 THEN simpulan_pemenuhan END AS clevel2,
						CASE WHEN kd_level=3 THEN simpulan_pemenuhan END AS clevel3,
						CASE WHEN kd_level=4 THEN simpulan_pemenuhan END AS clevel4,
						CASE WHEN kd_level=5 THEN simpulan_pemenuhan END AS clevel5
						
						FROM tlevel
						WHERE tahun='".$ctahun."' AND kd_apip='".$cinstansi."'
				...
				SELECT*FROM(	
				SELECT '0'jns,0 kd_elemen,0 kd_topik,nm_jns_elemen,kd_jns_elemen,bobot,0 varkali,''clevel1,''clevel2,''cevel3,''clevel4,''clevel5,'' skor_topik FROM ms_jns_elemen
				UNION
				SELECT '1'jns,kd_elemen,0 kd_topik,aa.nm_elemen,aa.kd_jns_elemen,aa.bobot,(SELECT bobot FROM ms_jns_elemen WHERE kd_jns_elemen=aa.kd_jns_elemen LIMIT 1)varkali,''clevel1,''clevel2,''cevel3,''clevel4,''clevel5,'' skor_topik FROM ms_elemen aa	
			)Z 
			)aa 
			)aaa 
		...
		$query="SELECT jns,kd_elemen,kd_topik,uraian,kd_jns_elemen,bobot,varkali,clevel1,clevel2,clevel3,clevel4,clevel5,skor_topik,ROUND(simpulan,4)simpulan,satuan, 
			...
			FROM(
				...
				(IFNULL(clevel1,0)+IFNULL(clevel2,0)+IFNULL(clevel3,0)+IFNULL(clevel4,0)+IFNULL(clevel5,0))skor_topik
				 FROM(
					SELECT tahun,kd_elemen,kd_apip,kd_topik,SUM(clevel1)clevel1,SUM(clevel2)clevel2,SUM(clevel3)clevel3,SUM(clevel4)clevel4,SUM(clevel5)clevel5,
						...
						WHERE a.tahun='".$ctahun."' AND a.kd_apip='".$cinstansi."' AND b.id_group='".$akses."'
					)z GROUP BY kd_elemen,kd_apip,kd_elemen,kd_topik
				...
				SELECT*FROM(
					...
					WHERE c.tahun='".$ctahun."' AND c.kd_apip='".$cinstansi."' AND c.id_group='".$akses."'
				UNION
					...
					WHERE bb.tahun='".$ctahun."' AND bb.kd_apip='".$cinstansi."' AND bb.id_group='".$akses."'
