<?php
	class InputBinwasModel extends CI_Model{

		var $table = 'ms_binwas a'; //nama tabel dari database
		...
		public function get_tree_parameter()
		{
			...
			$sql1 = 'SELECT * FROM ms_binwas WHERE LENGTH(id_parameter) = 3 and tahun = '.$thn;
			...
			if (count($res1)>0) {
				...
				foreach ($res1 as $value1) {
					$html .= '<div class="panel panel-default panel-headline-custom">
						  ...
						  ';	
					$sql2 = "SELECT * FROM ms_binwas WHERE LENGTH(id_parameter) = 5 and hd_parameter = '".$value1['id_parameter']."' and tahun = ".$thn;
					...
					if (count($res2)>0) {
						$html .= '<div id="collapse'.$value1["id_parameter"].'" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading'.$value1["id_parameter"].'">
						  ...
						  ';
						  	$sql3 = "SELECT * FROM ms_binwas WHERE LENGTH(id_parameter) = 7 and hd_parameter = '".$value2['id_parameter']."' and tahun = ".$thn;
		...
		public function get_parameter_pdf($id_daerah='',$thn = '')
		{
			...
			// $resHtml = '<table class="bpmTopnTailC" style="page-break-inside:avoid">
			// 			<thead>
			// 				<tr class="headerrow">
			...
			// 				<td rowspan = "'.$cresAll.'" style="text-align:center;vertical-align: middle;font-size:12pt;"></td>
			// 				<td rowspan = "'.$cresAll.'" style="text-align:center;vertical-align: middle;font-size:12pt;">Indeks Pengawasan Pemerintah Daerah</td>
			// 				<td rowspan = "'.$cresAll.'" style="text-align:center;vertical-align: middle;font-size:12pt;">'.$target.'%</td>
			// 				<td rowspan = "'.$cresAll.'" style="text-align:center;vertical-align: middle;font-size:12pt;">Nilai hasil binwas (oleh Itjen dan Itprov)</td>';	
			...
			$resHtml = '<table class="bpmTopnTailC"  border = "1" style="border-collapse:collapse;">
						<thead>
							...
							<tr class="headerrow" style="background: linear-gradient(90deg, rgba(228,227,227,1) 0%, rgba(201,201,203,1) 35%, rgba(181,181,181,1) 100%);">
								...
								<th style="border-bottom:none;text-align:center;vertical-align: middle;font-size:12pt;">Nilai hasil binwas (oleh Itjen dan Itprov)</th>
		...
		public function get_dashboard_binwas($id_daerah='',$thn = '')
		{
		...
		public function get_parameter_mdb($id_daerah='')
		{
			...
			if (count($res1)>0) {
				...
				foreach ($res1 as $value1) {
					...
					$drh1  = $value1['id_daerah'];
					// keterangan & file
					$sqlDtl1 = "SELECT keterangan, file FROM tr_binwas where id_parameter = '".$id_par1."' AND tahun =".$thn1." AND id_daerah ='".$drh1."'";
					...
					if (count($cekParameter1) >= 1) {
						foreach ($cekParameter1 as $val1) {
							...
							$file1 = '';
							// if ($val1->file <> '') {
							// 	$file1='<span><i class="fa fa-pdf-o ic-w mx-1 previewAtt" style="padding-top:2px;padding-right:5px;color:red;" data-url ="'.base_url()."assets/file_upload/binwas/".$thn1."/".$drh1."/".$id_par1."/".$files1.'"  data-toggle="tooltip" title="Preview File"></i></span>';
					...
					if (count($res2) == 0) {
						...
						foreach ($res2 as $value2) {
							...
							$bobot2  = $value2['bobot'];
							$drh2  	= $value2['id_daerah'];
							$sqlDtl2 = "SELECT keterangan, file FROM tr_binwas where id_parameter = '".$id_par2."' AND tahun =".$thn2." AND id_daerah ='".$drh2."'";
							...
							if (count($cekParameter2) >= 1) {
								foreach ($cekParameter2 as $val2) {
									...
									$file2 = '';
									// if ($val2->file <> '') {
									// 	$file2='<span><i class="fa fa-file-pdf-o ic-w mx-1 previewAtt" style="padding-top:2px;padding-right:5px;color:red;" data-url ="'.base_url()."assets/file_upload/binwas/".$thn2."/".$drh2."/".$id_par2."/".$files2.'"  data-toggle="tooltip" title="Preview File"></i></span>';
							...
							if (count($res3) == 0) {
								...
								foreach ($res3 as $value3) {
									...
									$sqlDtl3 = "SELECT keterangan, file FROM tr_binwas where id_parameter = '".$id_par3."' AND tahun =".$thn3." AND id_daerah ='".$drh3."'";
									...
									if (count($cekParameter3) >= 1) {
										foreach ($cekParameter3 as $val3) {
											...
											$file3 = '';
											// if ($val3->file <> '') {
											// 	$file3='<span><i class="fa fa-file-pdf-o ic-w mx-1 previewAtt" style="padding-top:2px;padding-right:5px;color:red;" data-url ="'.base_url()."assets/file_upload/binwas/".$thn3."/".$drh3."/".$id_par3."/".$files3.'"  data-toggle="tooltip" title="Preview File"></i></span>';
											// }else{
									...
									$html .= '<li><div class="treeview-animated-element"> 
												<table border = "0" width = "100%" style="border-top: 1px dotted black;border-bottom: 1px dotted black;">
													<tr>
														<td width="68%" style="font-size:12px;">	
															<table width = "100%">
																<tr>
																	<td width="10%" style="font-size:12px;">'.$id_par3.' .</td>
																	<td width="90%" style="font-size:12px;">'.$nm_par3.'</td>
