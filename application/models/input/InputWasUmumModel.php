<?php
	class InputWasUmumModel extends CI_Model{
		...
		public function add_parameter($data){
			$this->db->insert('tr_was_umum', $data);
			return true;
		}
		...
		public function get_parameter_pdf($id_daerah='',$thn = '')
		{
			...
			// $resHtml = '<table class="bpmTopnTailC">
			// 			<thead>
			// 				<tr class="headerrow">
			...
			foreach ($res1 as $value1) {
				...
				if ($jmlRes2 > 0) {
					...
					$html .= '<td rowspan = "'.$cres1.'" style="font-size:12pt;text-align:center;vertical-align: middle;">'.$no++.'</td>
								<td rowspan = "'.$cres1.'" style="font-size:12pt;text-align:center;vertical-align: middle;"></td>
								<td rowspan = "'.$cres1.'" style="font-size:12pt;text-align:center;vertical-align: middle;"></td>
								<td rowspan = "'.$cres1.'" style="font-size:12pt;text-align:center;vertical-align: middle;"></td>
								<td style="text-align:center;vertical-align: middle;font-size:12pt;">'.$nm_par1.'</td>
			...
			// 				<td rowspan = "'.$cresAll.'" style="text-align:center;vertical-align: middle;font-size:12pt;">Nilai hasil pengawasan umum (oleh Itjen dan Itprov)</td>';	
			...
			$resHtml = '<table class="bpmTopnTailC"  border = "1" style="border-collapse:collapse;">
						<thead>
							...
							<tr class="headerrow" style="background: linear-gradient(90deg, rgba(228,227,227,1) 0%, rgba(201,201,203,1) 35%, rgba(181,181,181,1) 100%);">
								...
								<th style="border-bottom:none;text-align:center;vertical-align: middle;font-size:12pt;">Nilai hasil pengawasan umum (oleh Itjen dan Itprov)</th>
		...
		public function get_dashboard_umum($id_daerah='',$thn = '',$tipe = '')
		{	
		...
		public function get_parameter_mdb($id_daerah='')
		{
			...
			if (count($res1)>0) {
				...
				foreach ($res1 as $value1) {
					...
					// keterangan & file
					$sqlDtl1 = "SELECT keterangan, file FROM tr_was_umum where id_parameter = '".$id_par1."' AND tahun =".$thn1." AND id_daerah ='".$drh1."'";
					...
					if (count($cekParameter1) >= 1) {
						foreach ($cekParameter1 as $val1) {
							...
							$file1 = '';
							// if ($val1->file <> '') {
							// 	$file1='<span><i class="fa fa-file-pdf-o ic-w mx-1 previewAtt" style="padding-top:2px;padding-right:5px;color:red;" data-url ="'.base_url()."assets/file_upload/umum/".$thn1."/".$drh1."/".$id_par1."/".$files1.'"  data-toggle="tooltip" title="Preview File"></i></span>';
							// }else{
					...
					if (count($res2) == 0) {
						...
						foreach ($res2 as $value2) {
							...
							$sqlDtl2 = "SELECT keterangan, file FROM tr_was_umum where id_parameter = '".$id_par2."' AND tahun =".$thn2." AND id_daerah ='".$drh2."'";
							...
							if (count($cekParameter2) >= 1) {
								foreach ($cekParameter2 as $val2) {
									...
									$file2 = '';
									// if ($val2->file <> '') {
									// 	$file2='<span><i class="fa fa-file-pdf-o ic-w mx-1 previewAtt" style="padding-top:2px;padding-right:5px;color:red;" data-url ="'.base_url()."assets/file_upload/umum/".$thn2."/".$drh2."/".$id_par2."/".$files2.'"  data-toggle="tooltip" title="Preview File"></i></span>';
							...
							if (count($res3) == 0) {
								...
								foreach ($res3 as $value3) {
									...
									$sqlDtl3 = "SELECT keterangan, file FROM tr_was_umum where id_parameter = '".$id_par3."' AND tahun =".$thn3." AND id_daerah ='".$drh3."'";
									...
									if (count($cekParameter3) >= 1) {
										foreach ($cekParameter3 as $val3) {
											...
											$file3 = '';
											// if ($val3->file <> '') {
											// 	$file3='<span><i class="fa fa-file-pdf-o ic-w mx-1 previewAtt" style="padding-top:2px;padding-right:5px;color:red;" data-url ="'.base_url()."assets/file_upload/umum/".$thn3."/".$drh3."/".$id_par3."/".$files3.'"  data-toggle="tooltip" title="Preview File"></i></span>';
											// }else{
		...
		public function edit_parameter($data, $id, $daerah,$thn){
			...
			$this->db->where('id_daerah', $daerah);
			$this->db->where('tahun', $thn);
			$this->db->update('tr_was_umum', $data);
			return true;
		}
