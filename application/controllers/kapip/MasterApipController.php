<?php
	 ...
	 * 
	 */
	class MasterApipController extends CI_Controller
	{
		
		public function __construct(){
			parent::__construct();
			date_default_timezone_set('Asia/Jakarta');
			$this->load->model('kapip/MasterApipModel', 'ApipModel');
		...
		public function get() {
			...
			$list = $this->ApipModel->get_all_apip();
