<?php
	...
	class ActivityController extends CI_Controller {
		...
		public function __construct(){
			parent::__construct();
			$this->load->model('admin/Activity_model', 'a_model');
		}

		public function index(){
			$data['view'] = 'admin/activity/activityView';
		...
		public function get() {
			$list = $this->a_model->get_all_manual();
	        $data = array();
	        $no = $_POST['start'];
	        ...
	        $output = array(
	            "draw" => $_POST['draw'],
	            "recordsTotal" => $this->a_model->count_all_manual(),
	            "recordsFiltered" => $this->a_model->count_filtered_manual(),
	            "data" => $data,
	        );
