...
class LaptriKomposisiSdmController extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['view'] = 'kapip/laporan/laporanKomposisiSdmView';
	...
	function laporan($ctahun,$cinstansi,$ctipe){ 
		...
		$cRet .= "<table width=\"100%\"><tr>
							<td width=\"100%\" align=\"center\">
								<h4><b>Struktur dan Komposisi Sumber Daya Manusia (SDM) APIP</b></h4>
				...
				$cRet .= "<div style='overflow-x:auto;'><table style=\"border-collapse:collapse;\" style=\"font-size:10\" width=\"90%\" align=\"center\" border=\"1\" cellspacing=\"0\" cellpadding=\"4\">
									...
									$csql = "SELECT a.urut,a.id_struktur_sdm,a.kd_apip,b.kd_struktur_sdm1,b.kd_struktur_sdm2,b.kd_struktur_sdm3,a.triw,
												...
												INNER JOIN tmap_struktur_sdm b ON a.id_struktur_sdm=b.id_struktur_sdm WHERE a.tahun='".$ctahun."' AND a.kd_apip='".$cinstansi."' AND a.triw='1' AND b.tampil='1'
												ORDER BY urut";
							...
							foreach ($res as $val) {
										$curut = $val->urut;
										$cid_struktur_sdm = $val->id_struktur_sdm;
										$ckd_struktur_sdm1 = $val->kd_struktur_sdm1;
										$ckd_struktur_sdm2 = $val->kd_struktur_sdm2;
										$ckd_struktur_sdm3 = $val->kd_struktur_sdm3;
										$curaian = $val->uraian;
										$clevel = $val->clevel;
										...
										for($i=2;$i<=4;$i++){
											...
											$query="SELECT nilai FROM tprofil_struktur_sdm WHERE kd_apip='".$cinstansi."' AND tahun='".$ctahun."' AND triw=".$i." AND id_struktur_sdm='".$cid_struktur_sdm."'";
	...
	public function pdf_laporan($ctahun='',$cinstansi='',$ctipe='')
	{
		...
		$filename = 'Struktur-dan-Komposisi-Sumber-Daya-Manusia-(SDM)-APIP.pdf'; 
	...
	{
		 $data['title']= 'Struktur dan Komposisi Sumber Daya Manusia (SDM) APIP';
		 $data['filename']= 'Struktur-dan-Komposisi-Sumber-Daya-Manusia-(SDM)-APIP';
