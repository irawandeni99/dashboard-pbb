            ...
            e.hasClass("treeview") && function(e) {
                ...
                e.find(".nested").hide(), r.off("click"), r.on("click", (function() {
                    var e = t(this),
                        ...
                        r1 = e.children(".fa-folder"),
                        i1 = e.children(".fa-folder-open");
                    e.toggleClass("open"), r.removeClass("fa-plus-circle"), r.addClass("fa-minus-circle"), i.removeClass("fa-minus-circle"), i.addClass("fa-plus-circle"),r1.removeClass("fa-folder"), r1.addClass("fa-folder-open"), i1.removeClass("fa-folder-open"), i1.addClass("fa-folder"), n.hasClass("active") ? n.removeClass("active").slideUp() : n.addClass("active").slideDown()
                })), n.off("click"), n.on("click", (function() {
                    var e = t(this);
