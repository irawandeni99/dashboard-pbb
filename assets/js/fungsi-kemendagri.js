	    		...
	    		load() {
	    			...
	    			chart.xAxis[0].labelGroup.element.childNodes.forEach(function(label) {
	    				...
	    				label.onclick = function() {
	    					if(divnya == "container-nilai-samping-1-kem" && par5 == 1){
	    						if (par4 == 'reviu') {
		    						var param = {};
		    						...
		    						param['tahun'] = par3;
		    						$.post(host+'dashboard-kemendagri-reviu/data_detail_chart_nilai_temuan', param, function(resp){
		    							if(resp){
	    						...
	    						if (par4 == 'pemeriksaan') {
		    						...
		    						// param['tahun'] = $('#tahun').val();
		    						param['tahun'] = par3;
		    						$.post(host+'dashboard-kemendagri-pemeriksaan/data_detail_chart_nilai_temuan', param, function(resp){
		    							if(resp){
		    								$('.judul').html('STATISTIK NILAI TEMUAN DAN PENYELESAIAN (SETORAN) '+param['group']);
		    								$('.listDetail').html(resp);
		    								$('.myModal').modal('show');
	    						...
	    						if (par4 == 'lainnya') {
		    						...
		    						// param['tahun'] = $('#tahun').val();
		    						param['tahun'] = par3;
		    						$.post(host+'dashboard-kemendagri-lainnya/data_detail_chart_nilai_temuan', param, function(resp){
		    							if(resp){
		    								$('.judul').html('STATISTIK NILAI TEMUAN DAN PENYELESAIAN (SETORAN) '+param['group']);
		    								$('.listDetail').html(resp);
		    								$('.myModal').modal('show');
	    					...
	    					if (divnya == "container-rekomendasi-sts" && par5 == 1){
	    						if (par4 == 'pemeriksaan') {
		    						...
		    						// param['tahun'] = $('#tahun').val();
		    						param['tahun'] = par3;
		    						$.post(host+'dashboard-kemendagri-pemeriksaan/data_detail_chart_sts_rekom', param, function(resp){
		    							if(resp){
	    						...
	    						if (par4 == 'reviu') {
		    						...
		    						// param['tahun'] = $('#tahun').val();
		    						param['tahun'] = par3;
		    						$.post(host+'dashboard-kemendagri/data_detail_chart_sts_rekom', param, function(resp){
		    							if(resp){
		    								$('.judul').html('STATISTIK STATUS REKOMENDASI '+param['group']);
		    								$('.listDetail').html(resp);
		    								$('.myModal').modal('show');
